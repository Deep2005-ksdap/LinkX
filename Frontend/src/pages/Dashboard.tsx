...
export default function Dashboard({theme, setTheme}) {
  ...
  return isAuthenticated ? (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <h1 className="text-center md:hidden dark:text-gray-100 font-semibold mt-2 py-2">Dashboard</h1>
        ...
        <div className="p-2 border rounded-xl bg-white dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="mt-3 flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 py-2 rounded-lg border bg-transparent focus:outline-none focus:ring-2 focus:ring-indigo-600 dark:focus:ring-gray-400"
            />
